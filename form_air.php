...
<head>
    ...
    <title>Book Air Bus - Premium Bus</title>
...
<?php render_booking_form([
    'category' => 'air',
    'icon' => 'fa-bus',
    'title' => 'Air Bus Booking',
    'subtitle' => 'Affordable group transport for your next outing',
    'theme' => 'air',
    'list_url' => 'list_air.php',
    'vehicles' => get_vehicles($conn, 'air'),
]); ?>
