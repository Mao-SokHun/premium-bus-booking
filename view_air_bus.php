...
<head>
    ...
    <title>Air Bus - Premium Bus</title>
...
<div class="page-wrap view-page page-inner">
    <div class="section-header center">
        <div class="section-eyebrow"><i class="fa-solid fa-bus"></i> Air Bus Fleet</div>
        <h2 class="page-title">Air Bus Vehicles</h2>
        <p class="section-desc">Affordable and reliable for family and school trips.</p>
    </div>
    <div class="row g-4 fleet-grid">
        <?php render_vehicle_cards_from_db($conn, 'air', 'form_air.php'); ?>
    </div>
